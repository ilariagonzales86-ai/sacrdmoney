...
export async function analyzeQuadrants(input: string): Promise<Record<string, string[]>> {
...
export async function generateMarketTitles(craftItems: string[]): Promise<string[]> {
